<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav sidebar-accordion"
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('dashboard.myleaverequests') }}" class="sidebar-link {{ request()->routeIs('dashboard.myleaverequests') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                My leave requests
            </a>
            <a href="{{ route('dashboard.myattendances') }}" class="sidebar-link {{ request()->routeIs('dashboard.myattendances') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                My Attendances
