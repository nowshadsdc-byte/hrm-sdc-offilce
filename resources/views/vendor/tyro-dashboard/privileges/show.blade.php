...
<div class="page-header">
    <div class="page-header-row">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route($dashboardRoute::name('privileges.edit'), $privilege->id) }}" class="btn btn-primary">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding: 0;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <div class="action-buttons" style="justify-content: flex-end;">
                                    <a href="{{ route($dashboardRoute::name('roles.show'), $role->id) }}" class="action-btn" title="View Role">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                        </svg>
                                    </a>
                                    <form action="{{ route($dashboardRoute::name('privileges.remove-role'), ['id' => $privilege->id, 'roleId' => $role->id]) }}" method="POST" id="remove-role-form-{{ $role->id }}">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="empty-state">
                ...
                <a href="{{ route($dashboardRoute::name('privileges.edit'), $privilege->id) }}" class="btn btn-sm btn-secondary">Assign to Roles</a>
            </div>
            @endif
        </div>
    </div>
